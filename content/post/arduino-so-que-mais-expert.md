...
draft: false
tags: ["arduino", "programação", "escola"]
links:
    - title: "O Guia +Hardcore de Introdução à COMPUTAÇÃO"
      website: "https://www.youtube.com/watch?v=8G80nuEyDN4"
      description: |
                   Vídeo do lendário Fábio Akita, ele traz conceitos fundamentais
                   de como computadores no geral funciona, mas acredito que qualquer
                   um será capaz de tirar uma coisa ou outra de útil desse vídeo pra
                   aplicar no seu próximo projeto.
    - title: "Machine That ______ When You ______"
      website: "https://www.youtube.com/watch?v=HaUzUwNBFcc"
      description: |
                   Um dos meus canais favoritos sobre ciência da computação, aqui
                   ele realmente traz uma introdução interessante sobre a plataforma
                   Arduino, de um jeito cômico que me atrai muito.
    - title: "Ben Eater"
      website: "https://www.youtube.com/channel/UCS0N5baNlQWJCUrhCEo8WlA"
      description: |
                   Não sou de eletrônica, longe disso. Mas esse canal é interessante
                   para ao menos os circuitos deixarem de ser mágica na minha cabeça.
    - title: "Documentação oficial da biblioteca Arduino.h"
      website: "https://reference.arduino.cc/reference/en/"
      description: |
                   É importante saber o que é possível fazer para criar coisas
                   em determinada linguagem, framework, etc. Recomendo gastar alguns
                   minutos da sua vida vendo o que essas funções fazem (mesmo sendo
                   a documentação oficial, ainda falta a parte avançada que irei
                   mostrar onde você pode encontrar nos próximos posts).
---
...
![Mapeamento dos pinos no processador ATmega328P](posts/ATmega328P-pins-Diagram_20022023-201213.png)
